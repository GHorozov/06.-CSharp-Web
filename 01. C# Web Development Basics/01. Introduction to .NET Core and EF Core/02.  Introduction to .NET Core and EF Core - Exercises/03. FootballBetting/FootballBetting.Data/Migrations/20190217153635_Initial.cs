        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BetMoney = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BetGame_Bets_BetId",
                        column: x => x.BetId,
                        principalTable: "Bets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BetGame_ResultPredictions_ResultPredictionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTime>(nullable: false),
                    HomeTeamWinBetRate = table.Column<double>(nullable: false),
                    AwayTeamWinBetRate = table.Column<double>(nullable: false),
                    DrawGameBetRate = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerAssists = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionTypes_CompetitionId",
