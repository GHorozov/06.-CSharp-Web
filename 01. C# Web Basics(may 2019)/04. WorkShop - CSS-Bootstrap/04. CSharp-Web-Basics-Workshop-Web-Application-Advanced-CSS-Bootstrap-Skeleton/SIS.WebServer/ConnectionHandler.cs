...
namespace SIS.WebServer
{
    public class ConnectionHandler
    {
        ...
        {
            var assebblyLocation = Assembly.GetExecutingAssembly().Location;
            var folderPrefix = "/../../../../";
            var resourceFolder = "Resources/";
            var requestedResouces = "css/bootstrap.min.css";
            var fullPath = assebblyLocation + folderPrefix + resourceFolder + requestedResouces;

            if (File.Exists(fullPath))
            {
                var byteContent = File.ReadAllBytes(fullPath);

                return new InlineResourceResult(byteContent, HttpResponseStatusCode.Found);
            }
            else
            {
